...
" Kindly fill the form given below and choose atlest two from the options provided below:-"
);
...
let lname_input = sixinput("input","type","text","class","form-control","id","last-name","placeholder","ENTER YOUR LASTNAME","required");
let address_input = sixinput("textarea","type","textarea","class","form-control","id","address","placeholder","ENTER YOUR ADDRESS","required");
let state_input = sixinput("input","type","text","class","form-control","id","state","placeholder","ENTER YOUR STATE","required");
let country_input = sixinput("input","type","text","class","form-control","id","country","placeholder","ENTER YOUR COUNTRY","required");
let pincode_input = sixinput("input","type","text","class","form-control","id","pincode","placeholder","ENTER YOUR PINCODE","required");

function sixinput( tagname, attname1, attvalue1 , attname2, attvalue2, attname3, attvalue3, attname4, attvalue4, attname5) {
...
function genderinput(tagname,attname1,attvalue1,attname2,attvalue2,attname3,attvalue3,attname4,attvalue4,attname5) {
...
let food_input3 = fooditemsinput("input","type","checkbox","name","food","value","Indian Cuisine: A Feast of Heritage ","class","checkbox");
let food_input4 = fooditemsinput("input", "type", "checkbox", "name", "food", "value", "Italian Cuisine: A Rustic Elegance ", "class", "checkbox");
let food_input5 = fooditemsinput( "input", "type", "checkbox", "name", "food", "value", "Greek Cuisine: A Medley of Aegean Flavors  ", "class", "checkbox");

function fooditemsinput(tagname,attname1, attvalue1, attname2, attvalue2, attname3, attvalue3, attname4, attvalue4) {
...
let food_label4 = fooditemslabel("label","for","food","Italian Cuisine: A Rustic Elegance ");
let food_label5 = fooditemslabel("label","for","food","Greek Cuisine: A Medley of Aegean Flavors");
...
function buttonele( tagname, class1, class2, class3, attname2, attvalue2, attname3, attvalue3, attname4, attvalue4, contenttext) {
...
maindiv.append(titlediv1,fname_div,lname_div,address_div,state_div,country_div,pincode_div,gender_div,food_div,button_div, table_div);
...
function btnname() {
  ...
  for (let i = 0; i < checkbox_value.length; i++) {
    if (checkbox_value[i].checked) {
      null_value.push(checkbox_value[i]);
    }
  }
